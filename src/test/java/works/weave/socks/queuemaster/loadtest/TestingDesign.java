...
public class TestingDesign extends BaseNeoLoadDesign {
    ...
    public void createVariables() {
        final com.neotys.neoload.model.v3.project.variable.ConstantVariable server = createConstantVariable("host", "queue-master");
        final com.neotys.neoload.model.v3.project.variable.ConstantVariable port = createConstantVariable("port", "80");
        final com.neotys.neoload.model.v3.project.variable.ConstantVariable cartserver = createConstantVariable("carts_host", "queue-master");
