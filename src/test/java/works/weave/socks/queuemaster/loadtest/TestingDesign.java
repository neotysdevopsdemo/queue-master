...
public class TestingDesign extends BaseNeoLoadDesign {
    ...
    public void createVariables() {
        final ConstantVariable server = createConstantVariable("host", "queue-master");
        final ConstantVariable port = createConstantVariable("port", "80");
        final ConstantVariable cartserver = createConstantVariable("carts_host", "queue-master");
